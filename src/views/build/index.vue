<template>
  <div class="container">
      ...
      <div class="components-list">
        <div v-for="(item,index) in componentsData" :key="index">
          ...
          <draggable
            ...
            @end="onEnd"
          >
            <div class="components-item" v-for="(jtem, jndex) in item.data" :key="jndex">
    ...
    <code-type-dialog :visible.sync="codeData.dialogVisible" :show-file-name="codeData.showFileName" @confirm="generate" />
  </div>
</template>

<script>
  import draggable from 'vuedraggable'
  import { inputComponents, selectComponents, layoutComponents, formConf } from '@/assets/js/generator/config'
